...
import { faUser, faEnvelope, faPencil, faAdd, faEnvelopeCircleCheck, faDna, faDownload, faUpload, faTrash, faCircleExclamation } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className='w-full flex flex-col gap-2 items-center justify-center'>
                <div className='w-full p-1 flex gap-1 bg-white rounded-md items-center justify-evenly'>
                    ...
                    <div className='p-2 flex gap-2 border-r-2'>
                        ...
                        <div className='flex flex-col'>
                            <span className='text-xs'>Pengajuan Aktif</span>
